...
export default function SpecialtyCoffeeGearEnthusiasts() {  
   return (
      ...
      <header className="bg-black/90 backdrop-blur-sm border-b border-gray-800 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-white">Nanofoamer — Speciality</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              Specialty-Grade Microfoam
                <span className="block text-gray-300">Precision texture for latte art</span>
              </h1>
              
              {/* Subheadline */}
              <p className="text-xl lg:text-2xl text-gray-400 leading-relaxed">
              Dial in your espresso, finish with flawless microfoam. Silky texture that
                highlights sweetness and supports crisp rosettas—at home or behind bar.
              </p>
            </div>
            ...
            <div className="bg-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-700">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <span className="text-lg font-semibold text-white">Built for Third-Wave Standardse</span>
              </div>
              <p className="text-gray-300">
              Fine, glossy microfoam for definition and pour control. Works great with whole milk
                and alt milks (oat/almond)—consistent results in seconds.
               </p>
            </div>
          ...
          <div className="relative">
                < img src={'/speciality_product.webp'} className="rounded-2xl"/>
 </div>
        </div>
      </section>
          ...
          <div className="flex justify-center items-center space-x-8 mb-8">
            <div className="flex items-center space-x-2 text-gray-300">
              ...
              <span className="text-sm">
                <span className="font-semibold text-white">{44}</span> enthusiasts viewing right now
              </span>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center space-x-2 text-gray-300">
              ...
              <span className="text-lg">
                <span className="font-bold text-white">{220}</span> enthusiasts have already preordered
              </span>
            </div>
